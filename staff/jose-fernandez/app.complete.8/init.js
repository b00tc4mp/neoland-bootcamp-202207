...
var btnMenu = homePage.querySelector('.btn-menu');
var nav = homePage.querySelector('.nav-home');
var btn_close=homePage.querySelector(".btn-close");
// ===================================================

// const registerLink = loginPage.querySelector('.link-register')
const login = registerPage.querySelector('.link-login')
...
const updatePassword = homePage.querySelector('.formPassword')
const updateEmail = homePage.querySelector('.formEmail')
