function NoteList({ notes, onDeleteNote, onUpdateNote, onCloseClick }) {
    ...
    {notes && notes.map(note => <li className="NoteList__item" key={note.id}>
        ...
        <p suppressContentEditableWarning='true' contentEditable="true"suppres className="NoteList__item-text" onKeyUp={event => {
