...
<textarea class="list__item-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut repudiandae molestias repellendus aliquid facere. Ullam dolore, nostrum possimus asperiores dignissimos, voluptatem ducimus sapiente aliquid facilis consequuntur sunt adipisci, nemo odit!
    ...
    temp3.innerHTML = `<div class="menu-panel">
          ...
          <ul class="dropdown-menu menu-panel__list">
            <li class="menu-panel__list-item-settings dropdown-item"><button class="dropdown__link settings-button"><i class="fa-solid fa-poo nav-icon poo-list-style"></i>Profile</button> </li>
              <li class="menu-panel__list-item-settings dropdown-item"><button class="dropdown__link notes-button"><i class="fa-solid fa-poo nav-icon poo-list-style"></i>Notes</button> </li>
              <li class="menu-panel__list-item-settings dropdown-item"><button class="dropdown__link logout-button"><i class="fa-solid fa-poo nav-icon poo-list-style"></i>Log out</button>  </li>
          </ul>
