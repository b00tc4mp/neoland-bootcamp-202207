function LoginPage(props) {
    ...
    return <main className="login-page page background flex-container">
    <div className="login-elements flex-container">
      <form action="" className=" login-form flex-container login-form" onSubmit={handleFormSubmit}>
      ...
      <a href="register.html" className="anchor" onClick={handleLinkClick}>Register</a>
    </div>
</main>
