class App extends Component {
    ...
    render() {
        ...
        if (this.state.view === 'register')
            return <RegisterPage onLinkClick={this.handleNavigationToLogin} onRegister={this.handleNavigationToLogin} />

        if (this.state.view === 'home')
            return <HomePage onLogoutClick={this.handleLogoutClick} onSettingsClick={this.props.handleSettingsClick}/>
    }
