...
describe("Splice", () => {
  ...
  it("negative count", () => {
    ...
    const result = letters.splice(2, 3, "C", "D");
  ...
  it("negative start", () => {
    ...
    const result = letters.splice(-5, 3, "C", "D");
  ...
  it("count greater than array length", () => {
    ...
    const result = letters.splice(2, 10, "C", "D");
  ...
  it("negative start less than 0", () => {
    ...
    const result = letters.splice(-10, 3, "A");
  ...
  it("start greater than array length", () => {
    ...
    const result = letters.splice(10, 3, "G", "H");
  ...
  it("count without input", () => {
    ...
    const result = letters.splice(2, 3);
