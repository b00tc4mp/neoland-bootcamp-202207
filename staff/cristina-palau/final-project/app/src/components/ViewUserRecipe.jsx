...
function ViewUserRecipe({ onBackClick, recipe, onViewPDF }) {
    ...
    return <>
        ...
        <div className="buttonContainer"><button className='transparentButton homeButton' onClick={() => onViewPDF(id)}>
            <span className="material-symbols-outlined">picture_as_pdf</span></button></div>
