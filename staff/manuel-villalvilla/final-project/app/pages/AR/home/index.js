...
function AR({ data, page, limit, province, search, categories }) {
  return <Home country_code={'AR'} data={data} page={page} limit={limit} province={province} search={search} categories={categories} />
}
