...
import './MovementInputs.css'
import retrieveProducts from "../logic/retrieveProducts";
import movementInputs from "../logic/movementInputs";

function MovementInputs({ context: { handleFeedback } }) {
  const logger = new Loggito(MovementInputs.name);
...
export default withContext(MovementInputs);
