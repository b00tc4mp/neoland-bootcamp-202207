...
login.onforgetPassLink(function() {
  document.body.removeChild(login.container)
  document.body.append(forgetPass.container)
})

forgetPass.onloginClick(function () {
  document.body.removeChild(forgetPass.container)
  document.body.append(login.container)
})
