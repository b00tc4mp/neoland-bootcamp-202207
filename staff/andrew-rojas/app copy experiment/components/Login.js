class Login {
  constructor() {
    ...
    temp.innerHTML = `<main class="login-page container container--spaced">
      ...
      <a class="anchor" href="#">Forget Password</a>
    
      <a class="anchor1" href="register.html">Register</a>
  ...
  onLinkClick(callback) {
    this.container.querySelector('.anchor1').onclick = event => {
